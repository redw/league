...
module DisplayUtil
{
    export function createCover(alpha?:number, coverWidth?:number, coverHeight?:number):eui.Group
    {
        var cover:eui.Group = new eui.Group();
...
//                console.log("delete fail!");
    ...
    export function getChildByName(parent:eui.Group, name:string):egret.DisplayObject
    {
        for (var i:number = 0; i < parent.numElements; i++)
        {
            var element:egret.DisplayObject = parent.getElementAt(i);
    ...
    export function changeBGready(parent:any): void 
    {
