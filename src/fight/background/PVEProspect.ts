 ...
 */
class PVEProspect extends egret.DisplayObjectContainer{
    ...
    protected moveCompleteCount:number = 0;
    ...
    public constructor(hasTween:boolean=true){
        ...
        this.priority = fight.LOAD_PRIORITY_MAP_BACKGROUND;
    ...
    protected move(dir:number){
        this.dir = dir;
        let off = this.moveDistance * dir;
        let time = fight.BACK_GROUND_MOVE_TIME;
